...
BEGIN
	EXECUTE format('INSERT INTO article_text_%s (id, pub_year, title, abstract, article_data, sections ) values ($1,$2,$3,$4,$5,$6)'::text, new.pub_year) 
		using new.id, new.pub_year, new.title, new.abstract, new.article_data, new.sections; 
	return null;
END
$$ language plpgsql;
