...
#     'min_size': 20,
#     'max_size': 60,
#     'max_inactive_connection_lifetime': 60*30,
...
def xml_path_iterator( path_dir ):
    return ( os.path.join(dp, f) for dp, dn, fn in os.walk(os.path.expanduser(path_dir)) for f in fn if os.path.splitext(f)[-1] in ('.nxml', '.xml') )


def filter_article( general_data, fulltext_data, ref_data={} ):
    """ Returning true means "drop the record", it is filtered out"""

    pub_year = int(general_data['publication_year'])
    if pub_year >= config.year_range.min and pub_year <= config.year_range.max:
        return False
...
def receive_xml_ts( path ):
    ...
    if filter_article( general_data, fulltext_data):
        return None
    ...
    while find:
        ...
        if pos >= 0:
            percent = ((pos+1) / len(fulltext)) * 100
            # print(round(percent))
    ...
    cite_vector = { 'љљ': [1 | tsvectorweight, rbound | tsvectorweight]} # i am abusing postgres ts_vector to my own needs, these two numbers are how i represent any given words left and right distance to the closest citation
        ...
        for word in words:
            ...
            if word not in stopwords and word != 'љљ':
                ...
                if sent_num >= last_left_cite: # current sentence is after a citation
                    entry[0] = (min( entry[0], ldistance ) ) | tsvectorweight
    ...
    for key,val in cite_vector.items():
        ...
        sort = sorted( val, key=lambda x: x & 0x3fff )
        newval = []
        lastval = -1
        for pos in sort:
            if lastval>0:
                
                if pmask(pos) == pmask(lastval):
                    # They are the same position, "merge" them by change their weight from 'A' and tsvectorweight to a different one
                    lastval = pmask(pos) | 0x8000
                else:
                    newval.append(lastval)
                    lastval = pos
            else:
                lastval = pos
...
async def insert_ts( data ):
    ...
    # ,'text_search'] )
    result = await con.copy_records_to_table( 'insert_dummy', records=filt_results, columns=['id','text_search','pub_year','cite_in_01', 'cite_in_02', 'cite_in_03', 'cite_in_04', 'cite_in_05', 'cite_in_06', 'cite_in_07', 'cite_in_08', 'cite_in_09', 'cite_in_10', 'cite_in_11', 'cite_in_12', 'cite_in_13', 'cite_in_14', 'cite_in_15', 'cite_in_16', 'cite_in_17', 'cite_in_18', 'cite_in_19', 'cite_in_20', 'cite_in_21', 'cite_in_22', 'cite_in_23', 'cite_in_24', 'cite_in_25', 'cite_in_26', 'cite_in_27', 'cite_in_28', 'cite_in_29', 'cite_in_30', 'cite_in_31', 'cite_in_32', 'cite_in_33', 'cite_in_34', 'cite_in_35', 'cite_in_36', 'cite_in_37', 'cite_in_38', 'cite_in_39', 'cite_in_40', 'cite_in_41', 'cite_in_42', 'cite_in_43', 'cite_in_44', 'cite_in_45', 'cite_in_46', 'cite_in_47', 'cite_in_48', 'cite_in_49', 'cite_in_50', 'cite_in_51', 'cite_in_52', 'cite_in_53', 'cite_in_54', 'cite_in_55', 'cite_in_56', 'cite_in_57', 'cite_in_58', 'cite_in_59', 'cite_in_60', 'cite_in_61', 'cite_in_62', 'cite_in_63', 'cite_in_64', 'cite_in_65', 'cite_in_66', 'cite_in_67', 'cite_in_68', 'cite_in_69', 'cite_in_70', 'cite_in_71', 'cite_in_72', 'cite_in_73', 'cite_in_74', 'cite_in_75', 'cite_in_76', 'cite_in_77', 'cite_in_78', 'cite_in_79', 'cite_in_80', 'cite_in_81', 'cite_in_82', 'cite_in_83', 'cite_in_84', 'cite_in_85', 'cite_in_86', 'cite_in_87', 'cite_in_88', 'cite_in_89', 'cite_in_90', 'cite_in_91', 'cite_in_92', 'cite_in_93', 'cite_in_94', 'cite_in_95', 'cite_in_96', 'cite_in_97', 'cite_in_98', 'cite_in_99', 'cite_in_100'] )
    # result = await con.copy_records_to_table( 'article_search', records=filt_results, columns=['id','pub_year','text_search','cite_in_01', 'cite_in_02', 'cite_in_03', 'cite_in_04', 'cite_in_05', 'cite_in_06', 'cite_in_07', 'cite_in_08', 'cite_in_09', 'cite_in_10', 'cite_in_11', 'cite_in_12', 'cite_in_13', 'cite_in_14', 'cite_in_15', 'cite_in_16', 'cite_in_17', 'cite_in_18', 'cite_in_19', 'cite_in_20', 'cite_in_21', 'cite_in_22', 'cite_in_23', 'cite_in_24', 'cite_in_25', 'cite_in_26', 'cite_in_27', 'cite_in_28', 'cite_in_29', 'cite_in_30', 'cite_in_31', 'cite_in_32', 'cite_in_33', 'cite_in_34', 'cite_in_35', 'cite_in_36', 'cite_in_37', 'cite_in_38', 'cite_in_39', 'cite_in_40', 'cite_in_41', 'cite_in_42', 'cite_in_43', 'cite_in_44', 'cite_in_45', 'cite_in_46', 'cite_in_47', 'cite_in_48', 'cite_in_49', 'cite_in_50', 'cite_in_51', 'cite_in_52', 'cite_in_53', 'cite_in_54', 'cite_in_55', 'cite_in_56', 'cite_in_57', 'cite_in_58', 'cite_in_59', 'cite_in_60', 'cite_in_61', 'cite_in_62', 'cite_in_63', 'cite_in_64', 'cite_in_65', 'cite_in_66', 'cite_in_67', 'cite_in_68', 'cite_in_69', 'cite_in_70', 'cite_in_71', 'cite_in_72', 'cite_in_73', 'cite_in_74', 'cite_in_75', 'cite_in_76', 'cite_in_77', 'cite_in_78', 'cite_in_79', 'cite_in_80', 'cite_in_81', 'cite_in_82', 'cite_in_83', 'cite_in_84', 'cite_in_85', 'cite_in_86', 'cite_in_87', 'cite_in_88', 'cite_in_89', 'cite_in_90', 'cite_in_91', 'cite_in_92', 'cite_in_93', 'cite_in_94', 'cite_in_95', 'cite_in_96', 'cite_in_97', 'cite_in_98', 'cite_in_99', 'cite_in_100'
    # ] )
...
async def run( data ):
    ...
    try:
        ...
        results = await asyncio.gather( insert_ts( data ), insert_text( data ) )
...
index_tmpl = """create index article_search_citations_{} on article_search_{} using GIN(text_search);"""
